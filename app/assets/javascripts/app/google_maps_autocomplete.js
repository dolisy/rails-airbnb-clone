function onPlaceChanged() {
  ...
  bookAddress.blur();
  bookAddress.value = components.address;

  document.getElementById('book_zip_code').value = components.zip_code;
  document.getElementById('book_city').value = components.city;

  if (components.country_code) {
    var selector = '#book_country option[value="' + components.country_code + '"]';
