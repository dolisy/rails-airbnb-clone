...
puts "creating 30 libraries..."
(0..20).to_a.each do
  library = Library.new(latitude: Faker::Address.latitude, longitude: Faker::Address.longitude, name: Faker::Address.city, user: User.all.order('RANDOM()').first())
  library.save!
end
